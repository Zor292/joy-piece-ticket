  ...
  if (command === 'tickets') {
    ...
    const mainSections = config.MAIN_TICKETS.map(key => {
      ...
      return {
        ...
        accessory: {
          type: 2,
          custom_id: `open_ticket_btn_${key}`,
          label: '-->',
          style: 2,
          emoji: { name: t.emoji },
        },
    ...
    const container = {
      ...
      components: [
        ...
        {
          type: 10,
          content: `## مرحباً بك في قائمة الدعم الفني لـ JoyPiece\nلمساعدتك في حل المشكلات والشكاوى، يمكنك فتح تذكرة من القائمة أدناه.`,
        },
        { type: 14 },
        // Rules section
        {
          type: 10,
          content: `**قبل فتح اي تكت يرجى قراءة القوانين التالية\nوالالتزام بها**\n\n${config.RULES_DESCRIPTION}`,
        },
        { type: 14 },
        // Main ticket buttons (Section style - text left, button right)
        ...mainSections,
        { type: 14 },
        // "أخرى" dropdown
        {
        ...
        {
          type: 10,
          content: `-# Developed by firas • JoyPiece Ticket System`,
        },
      ],
    };
